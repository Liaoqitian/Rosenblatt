...
\begin{figure}[H]
\includegraphics[scale = 0.4]{17_4}
\centering
\end{figure}
...
\end{lstlisting}
Now let us use the boilerplate code for a GET request using  \colorbox{lightgray}{fetch()} and  \colorbox{lightgray}{.then()} and manipulate it to access the Datamuse API and render information in the browser.
